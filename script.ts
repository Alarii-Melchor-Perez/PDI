...
// const characterActions = ['up','top ritght','right', 'down', 'right','down','jump'];
...
function drawSprite(img:any, sX:any, sY:any, sW:any, sH:any, dX:any, dY:any, dW:any, dH:any){
...
window.setInterval(animate, 1000/20);
